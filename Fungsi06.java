...
public class Fungsi06 {
    ...
    public static final int[] LAYU = { 1, 2, 0, 5 };
    ...
    public static void updateStok(int cabang) {
        System.out.println("========================================");
        System.out.println("Stock setelah dikurangi tanaman layu:");
        for (int i = 0; i < STOK[cabang - 1].length; i++) {
            System.out.print(NAMA_BUNGA[i]+" : ");
            System.out.println(STOK[cabang - 1][i]-LAYU[i]);
        }
        System.out.println("========================================");
        System.out.println("========================================");
    }
